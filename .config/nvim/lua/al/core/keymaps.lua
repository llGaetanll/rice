...
local keymaps = {
    ...
    -- Move Panes
    { mode = "n", keymap = "<S-Up>",          action = "<C-w>K",                      desc = "Move window above", },
    { mode = "n", keymap = "<S-Down>",        action = "<C-w>J",                      desc = "Move window below", },
    { mode = "n", keymap = "<S-Left>",        action = "<C-w>H",                      desc = "Move window left", },
    { mode = "n", keymap = "<S-Right>",       action = "<C-w>L",                      desc = "Move window right", },

    -- Navigate Tabs
    { mode = "n", keymap = "<c-l>",           action = "gt",                          desc = "next tab", },
    { mode = "n", keymap = "<c-h>",           action = "gT",                          desc = "prev tab", },
    ...
    -- NvimTree
    { mode = "n", keymap = "<leader>t",       action = "<cmd>NvimTreeToggle<CR>",     desc = "[t]oggle NvimTree", },
    { mode = "n", keymap = "<leader>T",       action = "<cmd>NvimTreeFocus<CR>",      desc = "Focus NvimTree", },

    -- Markdown
    { mode = "n", keymap = "<leader>mp",      action = "<cmd>MarkdownPreview<CR>",    desc = "Toggle Markdown Preview", },
    ...
    -- Telescope
    { mode = "n", keymap = "<leader>ff",      action = telescope_find_files,          desc = "[f]ind [f]iles", },
    { mode = "n", keymap = "<leader>fg",      action = telescope_live_grep,           desc = "[f]ile [g]rep", },
    { mode = "n", keymap = "<leader>fb",      action = telescope_buffers,             desc = "[f]ind [b]uffers", },
    { mode = "n", keymap = "<leader>fh",      action = telescope_help_tags,           desc = "[f]ind [h]elp", },
    { mode = "n", keymap = "<leader>gh",      action = telescope_highlights,          desc = "[g]et [h]ighlights", },
    { mode = "n", keymap = "<leader>kb",      action = telescope_keymaps,             desc = "[k]ey [b]indings", },
}
